...
using Example.UserService.WebAdmin.Extensions;
using Example.UserService.WebAdmin.Middleware;
using Example.UserService.WebAdmin.ModelBinding;
...
{
    options.ModelBinderProviders.Insert(0, new VietnamDateTimeOffsetModelBinderProvider());
});
...
builder.Services.AddSession(options =>
{
    ...
    options.Cookie.Name = ".WebAdmin.Session";
});
